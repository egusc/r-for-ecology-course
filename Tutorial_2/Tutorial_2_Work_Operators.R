...
#This file covers a range of comparison operators that can be used and how they can be used
...
#Find row by value in a field rather than the row number, which is unreliable
